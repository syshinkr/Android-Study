 ...
 * 시간 그래프
 */
public class HourActivity extends AppCompatActivity implements OnChartValueSelectedListener, OnChartGestureListener {
...
//            heartVals.add(new Axis(i, 70 + i*2));
    ...
    public boolean getIsHourExist() {
        ...
        Log.d("test", "hourData " + getSharedPreferences("isDataPref", MODE_PRIVATE).getBoolean("isHourExist", defaultFalse) );
        return getSharedPreferences("isDataPref", MODE_PRIVATE).getBoolean("isHourExist", defaultFalse);
    }
    ...
    public void initZeroChartData() {
        Toast.makeText(getApplicationContext(), "심박수 값을 받지 못했습니다", Toast.LENGTH_LONG).show();
