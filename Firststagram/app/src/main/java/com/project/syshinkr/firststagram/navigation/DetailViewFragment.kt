...
import com.project.syshinkr.firststagram.MainActivity

import com.project.syshinkr.firststagram.R
import com.project.syshinkr.firststagram.model.AlarmDTO
import com.project.syshinkr.firststagram.model.ContentDTO
import com.project.syshinkr.firststagram.model.FollowDTO
import com.project.syshinkr.firststagram.util.FcmPush
...
class DetailViewFragment : Fragment() {
    ...
    inner class DetailRecyclerViewAdapter: RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        fun getContents(followers: MutableMap<String, Boolean>?) {
            imageSnapshot = firestore?.collection("images")?.orderBy("timestamp")?.addSnapshotListener { querySnapshot, firebaseFirestoreException ->
                contentDTOs.clear()
